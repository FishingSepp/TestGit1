...
public class txtres {
	...
	int timed
	if(WebUI.waitForElementVisible(findTestObject('CuPaSc/Texts/Resize_text_topright'), 3)==false){
		WebUI.click(findTestObject('CuPaSc/Texts/Resize_text'))
		WebUI.waitForElementVisible(findTestObject('CuPaSc/Texts/Resize_text_topright'), 0)
		WebUI.delay(1)
	}
	WebUI.dragAndDropByOffset(findTestObject('CuPaSc/Texts/Resize_text_topright'), WebUI.getViewportLeftPosition() +
