...
public class rstart {
	...
	int timed
	WebUI.scrollToElement(findTestObject('CuPaSc/Restart/Restart'), 5)
	WebUI.click(findTestObject('CuPaSc/Restart/Restart'))
	WebUI.waitForElementVisible(findTestObject('CuPaSc/Restart/CopyLink'), 0)
	WebUI.delay(1)
	WebUI.click(findTestObject('CuPaSc/Restart/Accept'))
