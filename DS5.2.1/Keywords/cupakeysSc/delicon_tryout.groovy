...
public class delicon_tryout {
	...
	WebUI.clickOffset(findTestObject('body'), iconmap.('x'+iconcount), iconmap.('y'+iconcount))
	...
	WebElement todelete = WebUiCommonHelper.findWebElement(findTestObject('CuPaSc/Icons/Resize_Icon_topright'), 0)
	int delwidth = WebUI.getElementWidth(findTestObject('CuPaSc/Icons/Resize_Icon_topright'))
	int delheight = WebUI.getElementHeight(findTestObject('CuPaSc/Icons/Resize_Icon_topright'))
	int xpos = todelete.getLocation().x
	int ypos = todelete.getLocation().y
	//System.out.println("Element's Position from left side"+xpos +" pixels.")
	//System.out.println("Element's Position from top"+ypos +" pixels.")
	//System.out.println("click at" + (xpos + delwidth-10) + '  ' + ypos+10)
	
	WebUI.click(findTestObject('CuPaSc/delete/delete_delete1'))
	WebUI.delay(2)
	WebUI.clickOffset(findTestObject('body'), xpos + delwidth-10, ypos+10)//missing: save element location to reselect after placing more icons
