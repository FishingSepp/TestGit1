...
CustomKeywords.'cupakeysDl.color.changecolor'('solartsorange', LoadTimeCorrector, step, run, device, timeStamp); step ++

CustomKeywords.'cupakeysDl.chngstruct.changestructure'('angles', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('compass', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
