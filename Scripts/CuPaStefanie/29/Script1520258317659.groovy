...
CustomKeywords.'cupakeysDl.chngstruct.changestructure'('fadedrop', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(-225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('wave', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
