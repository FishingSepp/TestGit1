...
public class color {
	...
	def changecolor(String color, LoadTimeCorrector, step, run, device, timeStamp) {
		int timed
		if (WebUI.waitForElementVisible(findTestObject('CuPaSc/Color/Color'), 2)==true){
			WebUI.click(findTestObject('CuPaSc/Color/Color'))
		}
		else{
			WebUI.click(findTestObject('CuPaSc/MenuScroll/ScrollLeft'))
			WebUI.delay(1)
			WebUI.click(findTestObject('CuPaSc/Color/Color'))
		}
		//WebUI.click(findTestObject('CuPaSc/Color/Color'))
		WebUI.waitForElementVisible(findTestObject('CuPaSc/Color/Color_'+color), 0)
		WebUI.delay(1)
		WebUI.click(findTestObject('CuPaSc/Color/Color_' + color))
