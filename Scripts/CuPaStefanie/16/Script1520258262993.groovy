...
CustomKeywords.'cupakeysDl.color.changecolor'('jetblack', LoadTimeCorrector, step, run, device, timeStamp); step ++

CustomKeywords.'cupakeysDl.chngstruct.changestructure'('ring', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('minicooper', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
