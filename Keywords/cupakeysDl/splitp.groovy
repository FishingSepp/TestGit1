...
public class splitp {
	...
	@Keyword
	def split(String splitoption, LoadTimeCorrector, step, run, device, timeStamp){
	int timed
	WebUI.click(findTestObject('CuPaDl/Split/Split'))
	...
	WebUI.click(findTestObject('CuPaDl/Split/split_'+splitoption))
	...
	PrintWriter out2 = new PrintWriter(new BufferedWriter(new FileWriter(timeStamp + '_Run' + run + '.txt', true)));
