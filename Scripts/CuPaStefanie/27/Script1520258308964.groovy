...
CustomKeywords.'cupakeysDl.chngstruct.changestructure'('fadequadrop', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(-225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('hangloose', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
