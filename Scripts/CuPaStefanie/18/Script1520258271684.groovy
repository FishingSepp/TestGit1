...
CustomKeywords.'cupakeysDl.color.changecolor'('moonwalkgrey', LoadTimeCorrector, step, run, device, timeStamp); step ++

CustomKeywords.'cupakeysDl.chngstruct.changestructure'('fadedots', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('laurelwreath', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
