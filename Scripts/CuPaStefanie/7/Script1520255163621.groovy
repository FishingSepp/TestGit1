...
CustomKeywords.'cupakeysDl.color.changecolor'('electricblue', LoadTimeCorrector, step, run, device, timeStamp); step ++

CustomKeywords.'cupakeysDl.chngstruct.changestructure'('quadrops', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(-225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('pin', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
