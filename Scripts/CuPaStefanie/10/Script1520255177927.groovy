...
CustomKeywords.'cupakeysDl.color.changecolor'('rebelgreen', LoadTimeCorrector, step, run, device, timeStamp); step ++

CustomKeywords.'cupakeysDl.chngstruct.changestructure'('dots', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('paperplane', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
