...
public class txtres {
	...
	int timed
	if(WebUI.waitForElementVisible(findTestObject('CuPaSc/Texts/Resize_text_rightside'), 3)==false){
		WebUI.click(findTestObject('CuPaSc/Texts/Resize_text'))
		WebUI.waitForElementVisible(findTestObject('CuPaSc/Texts/Resize_text_rightside'), 0)
		WebUI.delay(1)
	}
	WebUI.dragAndDropByOffset(findTestObject('CuPaSc/Texts/Resize_text_rightside'), WebUI.getViewportLeftPosition() +
