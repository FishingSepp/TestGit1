...
public class txtfont {
	...
	@Keyword
	def textfont (String font, LoadTimeCorrector, step, run, device, timeStamp){
	int timed
	WebUI.click(findTestObject('CuPaSc/Texts/Edit_text'))
	WebUI.waitForElementVisible(findTestObject('CuPaSc/Texts/Font_serif'), 0)
	WebUI.delay(1)
	WebUI.click(findTestObject('CuPaSc/Texts/Font_'+font))
	WebUI.delay(1)
