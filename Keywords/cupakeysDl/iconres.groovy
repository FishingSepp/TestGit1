...
public class iconres {
	...
	@Keyword
	def iconresize (int iconscaling, LoadTimeCorrector, step, run, device, timeStamp){
	int timed
	...
	WebUI.dragAndDropByOffset(findTestObject('CuPaDl/Icons/Resize_icon_bottomright'), WebUI.getViewportLeftPosition() + 
