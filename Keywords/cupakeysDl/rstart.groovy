...
public class rstart {
	...
	@Keyword
	def restart (LoadTimeCorrector, step, run, device, timeStamp){
	int timed
	WebUI.scrollToElement(findTestObject('CuPaDl/Restart/Restart'), 5)
	WebUI.click(findTestObject('CuPaDl/Restart/Restart'))
	WebUI.waitForElementVisible(findTestObject('CuPaDl/Restart/CopyLink'), 0)
	WebUI.delay(1)
	WebUI.click(findTestObject('CuPaDl/Restart/Accept'))
