...
public class chngstruct {
	...
	def changestructure(String structure, LoadTimeCorrector, step, run, device, timeStamp){
		int timed
		WebUI.click(findTestObject('CuPaSc/Structure/Structure'))
		WebUI.waitForElementVisible(findTestObject('CuPaSc/Structure/Structure_Hahnentritt'), 0)
		WebUI.delay(1)
		WebUI.click(findTestObject('CuPaSc/Structure/Structure_'+structure))
