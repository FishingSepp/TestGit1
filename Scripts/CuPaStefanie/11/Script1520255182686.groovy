...
CustomKeywords.'cupakeysDl.color.changecolor'('passionred', LoadTimeCorrector, step, run, device, timeStamp); step ++
...
iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('paperplaneline', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
