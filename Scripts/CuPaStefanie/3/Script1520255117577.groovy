...
CustomKeywords.'cupakeysDl.chngstruct.changestructure'('chess', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(-225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('racing', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
