...
CustomKeywords.'cupakeysDl.color.changecolor'('thundergrey', LoadTimeCorrector, step, run, device, timeStamp); step ++

CustomKeywords.'cupakeysDl.chngstruct.changestructure'('fadehahnentritt', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('helmet', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
