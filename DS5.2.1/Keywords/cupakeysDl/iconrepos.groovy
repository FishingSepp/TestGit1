...
public class iconrepos {
	...
	int timed
	if(WebUI.waitForElementVisible(findTestObject('CuPaDl/Icons/Reposition_icon'), 3)==false){
		WebUI.click(findTestObject('CuPaDl/Icons/Resize_icon'))
		WebUI.waitForElementVisible(findTestObject('CuPaDl/Icons/Reposition_icon'), 0)
		WebUI.delay(1)
	}
	WebUI.dragAndDropByOffset(findTestObject('CuPaDl/Icons/Reposition_icon'), reposx, reposy)
	//WebUI.dragAndDropByOffset(findTestObject('CuPaDl/Icons/Reposition_icon'), WebUI.getViewportLeftPosition() + reposx,
