...
public class sclstruct {
	...
	int timed
	if(WebUI.waitForElementVisible(findTestObject('CuPaSc/Structure/Resize_Structure_bottomright'), 3)==false){
		WebUI.click(findTestObject('CuPaSc/Structure/Resize_Structure'))
		WebUI.waitForElementVisible(findTestObject('CuPaSc/Structure/Resize_Structure_bottomright'), 0)
		WebUI.delay(1)
	}
	WebUI.dragAndDropByOffset(findTestObject('CuPaSc/Structure/Resize_Structure_bottomright'), WebUI.getViewportLeftPosition() +
