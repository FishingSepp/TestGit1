...
CustomKeywords.'cupakeysDl.chngstruct.changestructure'('fadeangel', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('snow', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
