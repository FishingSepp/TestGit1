...
CustomKeywords.'cupakeysDl.color.changecolor'('lapisblue', LoadTimeCorrector, step, run, device, timeStamp); step ++

CustomKeywords.'cupakeysDl.chngstruct.changestructure'('fadedotscircular', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(-225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('longboard', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
