...
public class txtfont {
	...
	int timed
	WebUI.click(findTestObject('CuPaDl/Texts/Edit_text'))
	WebUI.waitForElementVisible(findTestObject('CuPaDl/Texts/Font_Bold'), 0)
	WebUI.delay(1)
	WebUI.click(findTestObject('CuPaDl/Texts/Font_'+font))
	WebUI.delay(1)
