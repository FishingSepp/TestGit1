...
public class txtrepos {
	...
	@Keyword
	def textreposition (int reposx, int reposy, LoadTimeCorrector, step, run, device, timeStamp){
	int timed
	...
	WebUI.dragAndDropByOffset(findTestObject('CuPaDl/Texts/Reposition_text'), reposx, reposy)
	//WebUI.dragAndDropByOffset(findTestObject('CuPaDl/Texts/Reposition_text'), WebUI.getViewportLeftPosition() + reposx,
