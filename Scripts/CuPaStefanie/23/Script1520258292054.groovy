...
CustomKeywords.'cupakeysDl.color.changecolor'('caribeanaqua', LoadTimeCorrector, step, run, device, timeStamp); step ++

CustomKeywords.'cupakeysDl.chngstruct.changestructure'('fadechessboard', LoadTimeCorrector, step, run, device, timeStamp); step ++
CustomKeywords.'cupakeysDl.sclstruct.scalestructure'(-225, LoadTimeCorrector, step, run, device, timeStamp); step ++

iconmap += CustomKeywords.'cupakeysDl.iconad.iconadd'('surf', LoadTimeCorrector, step, run, device, timeStamp, iconcount); step ++; iconcount++
